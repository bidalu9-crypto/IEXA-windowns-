  ...
  const tools: AgentToolDefinition[] = [
    {
      ...
      parameters: {
        ...
        captureFrame: { type: 'boolean', description: 'Attach a fresh PNG of the bound window. Defaults true for vision-capable profiles and false for text-only profiles.' },
